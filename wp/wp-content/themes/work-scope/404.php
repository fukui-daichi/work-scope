...
<main class="not-found-page" data-hx-target>
  ...
  <section class="not-found">
    <div class="inner">
      ...
      <a href="/" class="module-primary-button" hx-get="/" hx-swap="outerHTML transition:true show:window:top" hx-push-url="true" hx-target="[data-hx-target]" hx-select="[data-hx-target]">
