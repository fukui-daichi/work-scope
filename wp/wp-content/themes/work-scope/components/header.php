      ...
      <div class="navlist-wrapper">
        <ul class="navlist">
          ...
          <li class="buttons">
            ...
            <a href="/contact" class="module-contact-button" hx-get="/contact" hx-swap="outerHTML transition:true" hx-push-url="true" hx-target="[data-hx-target]" hx-select="[data-hx-target]">お問い合わせ</a>
          </li>
        </ul>
      </div>
    </nav>
